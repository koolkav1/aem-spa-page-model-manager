...
export class AuthoringUtilsService {
  ...
  public static readonly AUTHORING_LIBRARIES = {
    JS: [
      `${AuthoringUtilsService.EDITOR_CLIENTLIB_PATH}internal/messaging.js`,
      `${AuthoringUtilsService.EDITOR_CLIENTLIB_PATH}utils.js`,
      `${AuthoringUtilsService.EDITOR_CLIENTLIB_PATH}internal/page.js`,
      `${AuthoringUtilsService.EDITOR_CLIENTLIB_PATH}internal/pagemodel/messaging.js`
    ],
    CSS: [
      `${AuthoringUtilsService.EDITOR_CLIENTLIB_PATH}internal/page.css`
    ],
    META: {
      'cq:wcmmode': 'disabled'
    }
  ...
  constructor(@Inject(DOMAIN_TOKEN) domain: string | null, pathUtils: PathUtilsService) {
  ...
  public getAemLibraries(): DocumentFragment {
    ...
    const jsUrls = this.prependDomain(AuthoringUtilsService.AUTHORING_LIBRARIES.JS);
    const cssUrls = this.prependDomain(AuthoringUtilsService.AUTHORING_LIBRARIES.CSS);
    const metaInfo = AuthoringUtilsService.AUTHORING_LIBRARIES.META;
